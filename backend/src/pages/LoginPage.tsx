        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div className="modal-field" style={{ marginBottom: '1.5rem' }}>
            ...
            <input
              ...
              placeholder={mode === 'register' ? 'Min 10 chars, upper, number, symbol' : ''}
            />
          </div>
          {error && <p className="login-error">{error}</p>}
          <button className="btn-primary" type="submit" disabled={loading} style={{ width: '100%', marginBottom: '0.75rem' }}>
