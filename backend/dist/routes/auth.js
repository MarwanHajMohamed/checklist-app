...
function signAccess(userId, role) {
    ...
    return jsonwebtoken_1.default.sign({ sub: userId, role }, process.env.JWT_ACCESS_SECRET, {
...
router.post('/register', async (req, res) => {
    try {
        ...
        const user = await User_1.default.create({ email: email.toLowerCase(), passwordHash });
